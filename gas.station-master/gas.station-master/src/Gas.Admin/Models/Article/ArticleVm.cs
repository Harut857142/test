...
namespace Gas.Admin.Models.Article
{
    public class ArticleVm
    {
        ...
        public PagedResult<Shared.Models.Core.Article> List { get; set; }
        public bool IsEmpty()
        {
            return String.IsNullOrEmpty(SearchType);
        }
        
        public Shared.Models.Core.Article ParentArticle { get; set; } 
        ...
        public ArticleVm()
        {
            List = new PagedResult<Shared.Models.Core.Article>();
        }
        public ArticleVm(PagedResult<Shared.Models.Core.Article> list)
        {
            List = list;
        }
        ...
        public void FromFilter(ArticleFilter filter)
        {
