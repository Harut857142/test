...
//            context.Database.Migrate();
            ...
            if (!context.Permissions.Any())
            {
                ...
                context.Permissions.Add(new Permission()
                {
                    ModuleNumber = (int)Modules.Home,
                    ModuleName = "HomeModule.Index",
                    PermissionName = "Index",
                    Description = "Home Index",
                    PermissionNumber = (int)HomeModule.Index,
                });

                // Permission
                context.Permissions.Add(new Permission()
                {
                    ModuleNumber = (int)Modules.Permission,
                    ModuleName = "PermissionModule.Index",
                    PermissionName = "Index",
                    Description = "Permission Index",
                    PermissionNumber = (int)PermissionModule.Index,
                });
                context.Permissions.Add(new Permission()
                {
                    ModuleNumber = (int)Modules.Permission,
                    ModuleName = "PermissionModule.Edit",
                    PermissionName = "Edit",
                    Description = "Permission Edit",
                    PermissionNumber = (int)PermissionModule.Edit,
                });
                
                // Role
                context.Permissions.Add(new Permission()
                {
                    ModuleNumber = (int)Modules.Role,
                    ModuleName = "RoleModule.Index",
                    PermissionName = "Index",
                    Description = "Role Index",
                    PermissionNumber = (int)RoleModule.Index,
                });
                context.Permissions.Add(new Permission()
                {
                    ModuleNumber = (int)Modules.Role,
                    ...
                    PermissionNumber = (int)RoleModule.Edit,
                });
                // User
                context.Permissions.Add(new Permission()
                {
                    ModuleNumber = (int)Modules.User,
                    ModuleName = "UserModule.Index",
                    PermissionName = "Index",
                    Description = "User Index",
                    PermissionNumber = (int)UserModule.Index,
                });
                context.Permissions.Add(new Permission()
                {
                    ModuleNumber = (int)Modules.User,
                    ...
                    PermissionNumber = (int)UserModule.Edit,
                });
                // Device
                context.Permissions.Add(new Permission()
                {
                    ModuleNumber = (int)Modules.Device,
                    ModuleName = "DeviceModule.Index",
                    PermissionName = "Index",
                    Description = "Device Index",
                    PermissionNumber = (int)DeviceModule.Index,
                });
                context.Permissions.Add(new Permission()
                {
                    ModuleNumber = (int)Modules.Device,
                    ModuleName = "DeviceModule.Edit",
                    PermissionName = "Edit",
                    Description = "Device Edit",
                    PermissionNumber = (int)DeviceModule.Edit,
                });
            ...
            if (!context.RolePermissions.Any())
            {
                ...
                var currentRole = context.Roles.Where(r => r.SystemName == "superadmin").ToList()[0];
            ...
            {
                var currentUser = context.Users.Where(r => r.Email == "super@puper.com").ToList()[0];
                var currentRole = context.Roles.Where(r => r.SystemName == "superadmin").ToList()[0];
